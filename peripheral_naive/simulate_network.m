function [axons,success] = simulate_network(r,axon_coord,node_coord,beta,step_length,max_step,self_attract,NameValueArgs)
...
while any(grow) & (count<max_step)
    ...
    [axon_coord,nvarg_struct,grow,axons] = axon_growth_selective(r,axons,grow,axon_coord,node_coord,beta,step_length,nvcell{:});
    count = count + 1;
end
success = ~grow;
