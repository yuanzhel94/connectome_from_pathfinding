function [new_axon_coord,new_nvstruct,grow,axons] = axon_growth_selective(r,axons,grow,axon_coord,node_coord,beta,step_length,NameValueArgs)
...
[updated_coord,new_unitF] = grow_axons(axon_coord,node_coord,beta,step_length,nvargs{:});
